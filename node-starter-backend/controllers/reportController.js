...
function calculateWeeklyReports(weeklyReports) {
  ...
  weekWiseReports = Object.keys(weekWiseReports).map((key) => {
    ...
    singleWeekTotalReports.timeManagement =
      Math.round(timeManagement * 100) / 100;
    singleWeekTotalReports.overallAssessment =
      Math.round(overallAssessment * 100) / 100;
    singleWeekTotalReports.communicationSkill =
      Math.round(communicationSkill * 100) / 100;
    singleWeekTotalReports.attendanceParticipation =
      Math.round(attendanceParticipation * 100) / 100;
...
function calculateFinalReports(projectReports, weeklyReports) {
  ...
  data.attendanceParticipation =
    Math.round(data.attendanceParticipation * 100) / 100;
